...
@{
    ...
    FunctionsToExport = @('Export-XBWin32Log','Get-XBWin32FileEvents','Get-XBWin32LogDetails','Get-XBWin32NetworkEvents','Get-XBWin32ProcessEvents','Get-XBWin32Timeline','New-XBWin32ScheduledExportTask','Set-XBWin32AuditPolicyWizard')
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = @()
    PrivateData       = @{
